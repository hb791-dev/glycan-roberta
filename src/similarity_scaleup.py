...
def export_public_scaleup_html(
    ...
    - start from the HTML pages already generated by the analysis
    - keep relative links working by preserving local filenames/paths
    ...
    initial_source_paths.extend(Path(path).resolve() for path in source_saved_paths.get("query_html_paths", {}).values())
