    ...
    return [
        {
            ...
            "tokenizer_targets": {
                ...
                "linkage_block": {
                    "masked_sequence": "Galb1-4<mask>Mana1-3Manb1-4GlcNAcb1-4GlcNAc",
                    "expected_token": "GlcNAcb1-2",
                    "target_token_type": "linkage_block",
                },
                "donor_bound": {
                    "masked_sequence": "Galb1-4<mask>-2Mana1-3Manb1-4GlcNAcb1-4GlcNAc",
                    "expected_token": "GlcNAcb1",
        ...
        },
        {
            ...
            "tokenizer_targets": {
                ...
                "linkage_block": {
                    "masked_sequence": "NeuAca2-3<mask>GlcNAcb1-2Mana1-3(Galb1-4GlcNAcb1-2Mana1-6)Manb1-4GlcNAc",
                    "expected_token": "Galb1-4",
                    "target_token_type": "linkage_block",
                },
                "donor_bound": {
                    "masked_sequence": "NeuAca2-3<mask>-4GlcNAcb1-2Mana1-3(Galb1-4GlcNAcb1-2Mana1-6)Manb1-4GlcNAc",
        ...
        },
        {
            ...
            "tokenizer_targets": {
                ...
                "linkage_block": {
                    "masked_sequence": "Mana1-6(Mana1-3)<mask>GlcNAcb1-4GlcNAc",
                    "expected_token": "Manb1-4",
                    "target_token_type": "linkage_block",
                },
                "donor_bound": {
                    "masked_sequence": "Mana1-6(Mana1-3)<mask>-4GlcNAcb1-4GlcNAc",
                    "expected_token": "Manb1",
                    "target_token_type": "donor_bound",
                },
                "semi_atomic": {
                    "masked_sequence": "Mana1-6(Mana1-3)<mask>b1-4GlcNAcb1-4GlcNAc",
        ...
        },
        {
            ...
            "tokenizer_targets": {
                ...
                "linkage_block": {
                    "masked_sequence": "<mask>Galb1-4GlcNAcb1-6Man",
                    "expected_token": "Fuca1-3",
                    "target_token_type": "linkage_block",
                },
                "donor_bound": {
                    "masked_sequence": "<mask>-3Galb1-4GlcNAcb1-6Man",
                    "expected_token": "Fuca1",
                    "target_token_type": "donor_bound",
                },
                "semi_atomic": {
                    "masked_sequence": "<mask>a1-3Galb1-4GlcNAcb1-6Man",
        ...
        },
        {
            ...
            "tokenizer_targets": {
                ...
                "linkage_block": {
                    "masked_sequence": "<mask>Galb1-4GlcNAc",
                    "expected_token": "NeuAca2-3",
                    "target_token_type": "linkage_block",
                },
                "donor_bound": {
                    "masked_sequence": "<mask>-3Galb1-4GlcNAc",
                    "expected_token": "NeuAca2",
                    "target_token_type": "donor_bound",
                },
                "semi_atomic": {
                    "masked_sequence": "<mask>a2-3Galb1-4GlcNAc",
